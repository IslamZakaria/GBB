...
@Component({
  selector: 'app-ksa-map',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="container">
      <h1>KSA Regions Map</h1>
      <div class="map-container">
        <div class="tooltip" [style.left.px]="tooltipX" [style.top.px]="tooltipY" *ngIf="activeRegion">
          <h3>{{ activeRegion.name }}</h3>
          <p>{{ activeRegion.description }}</p>
        </div>
        <svg viewBox="0 0 800 600" style="width: 100%; height: 100%;">
          <!-- Add SVG paths for each region here -->
          <path *ngFor="let region of regions"
                [id]="region.id"
                [attr.d]="getRegionPath(region.id)"
...
export class KSAMapComponent {
  regions: RegionData[] = [
    {
      id: 'riyadh',
      name: 'Ar Riyāḑ',
      description: 'The capital and largest region of Saudi Arabia'
    },
    {
      id: 'makkah',
      name: 'Makkah',
      description: 'Home to the holy cities of Makkah and Jeddah'
    },
    {
      id: 'madinah',
      name: 'Al Madīnah',
      description: 'Location of the Prophet\'s Mosque and historical sites'
    },
    {
      id: 'eastern',
      name: 'Ash Sharqīyah',
      description: 'Major oil production region and home to important ports'
    },
    {
      id: 'qassim',
      name: 'Al Qaşīm',
      description: 'Known for its agricultural production and traditional markets'
    },
    {
      id: 'hail',
      name: 'Ḩāil',
      description: 'Rich in agricultural areas and historical landmarks'
    },
    {
      id: 'tabuk',
      name: 'Tabūk',
      description: 'Strategic location with important historical sites'
    },
    {
      id: 'northern',
      name: 'Al Ḩudūd ash Shamālīyah',
      description: 'Important border region with unique geography'
    },
    {
      id: 'jazan',
      name: 'Jīzān',
      description: 'Coastal region known for its ports and agriculture'
    },
    {
      id: 'najran',
      name: 'Najrān',
      description: 'Historical region with unique architecture and culture'
    },
    {
      id: 'bahah',
      name: 'Al Bāḩah',
      description: 'Known for its forests and traditional villages'
    },
    {
      id: 'jawf',
      name: 'Al Jawf',
      description: 'Rich in groundwater resources and agricultural areas'
    },
    {
      id: 'asir',
      name: 'Asir',
      description: 'Known for its mountains and moderate climate'
    }
  ];

  activeRegion: RegionData | null = null;
  tooltipX = 0;
  tooltipY = 0;
...
@Component({
  ...
  template: `
    <nav>
      ...
      <a routerLink="/ksa-map">KSA Map</a>
    </nav>
...
const routes: Routes = [
  ...
  { path: 'ksa-map', component: KSAMapComponent },
